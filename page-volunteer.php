        ...
        <div id="top-content-links">
          ...
          <div class="top-content-linkbox">
            <a href="<?php bloginfo('url'); ?>/volunteers/become-a-volunteer/#faqs">
              <h2>I'd like to know more.</h2>View our FAQs and map<br>
              & locations.
            </a>
          </div><!-- top content linkbox -->

          <div class="top-content-linkbox">
            <a href="<?php bloginfo('url'); ?>/volunteers/become-a-volunteer/#recruit">
              <h2>I'd like to help recruit others.</h2>View our volunteer recruitment resources. 
            </a>
          </div><!-- top content linkbox -->
